    ...
    return (
        <main className="p-10 flex justify-around items-center">
            <div className="flex flex-col gap-6">
                ...
                <Link href="/Home" className={`font-bold text-xl max-w-max border-black border-2 py-3 px-10 rounded-lg transition ease-in-out ${styles.button} relative hover:text-black`}>
                    <p>Get Started</p>
                </Link>     
            </div>
            <div>
